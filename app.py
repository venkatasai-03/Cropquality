...
categories = ['Corn', 'Grape', 'Peach', 'Sugarcane', 'Apple', 'Cauliflower', 'Papaya', 'Pepper', 'Potatos', 'Tomatos', 'Wheat']
quality_labels = ['q=95', 'q=80', 'q=60', 'q=40']

IMG_SIZE = 128  # Image size used for training

# Load the model
model_path = "C:/Users/venka/crop_quality_model_25.h5"
